...
delayend=10; # how long do we run the thing - 30 is too long 
...
for sigma in sigmarange
	for q in qrange 
		...
		mkdir("Run_sigma$(sigma)q$(q)freeparam$(freeparam)/MaxActivity") # dir where the activities will be stored 
